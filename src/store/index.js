...
export default new Vuex.Store({
  state: {
    forces: [
                  {id: 1, lat: 31.924611, lon: 34.897001, name:'אמבולנס 879', type:'מד"א', event:"תאונת דרכים צומת תפוח"},
                  {id: 2, lat: 31.224611, lon: 35.924567, name:'פלוגת הראל', type:'669'},
                  {id: 3, lat: 31.424611, lon: 35.124567, name:'גדוד 33', type:'תאג"ד', event:"שריפה בארמון הנציב"},
                  {id: 4, lat: 31.153093, lon: 34.088673, name:'גדוד 30', type:'תאג"ד'},
                  {id: 5, lat: 31.524611, lon: 34.597001, name:'מ"פ גולן', type:'מג"ב'},
                  {id: 6, lat: 31.524611, lon: 35.324567, name:'גדוד 40', type:'תאג"ד'},
                  {id: 7, lat: 31.924611, lon: 35.324567, name:'גדוד 50', type:'תאג"ד'},
                  {id: 8, lat: 31.253093, lon: 34.788673, name:'גדוד 60', type:'תאג"ד'},
